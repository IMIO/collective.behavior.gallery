...
class FolderishGalleryIntegrationTest(unittest.TestCase):
    ...
    def test_behavior_folderish_gallery(self):
        behavior = getUtility(IBehavior, 'collective.behavior.gallery.folderish_gallery')
        self.assertEqual(
            behavior.marker,
            IFolderishGallery,
        )
        behavior_name = 'collective.behavior.gallery.behaviors.folderish_gallery.IFolderishGallery'
